#include <bits/stdc++.h>
using namespace std;
// A championship is held in Berland, in which n
//  players participate. The player with the number i
//  has ai
//  (ai≥1
// ) tokens.

// The championship consists of n−1
...
// The first line of each test case consists of one positive integer n
//  (1≤n≤2⋅105
